...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_votes[county_name] > winning_county_votes) and (county_percentage > winning_county_percentage):
            winning_county = county_name
            winning_county_votes = votes_county
            winning_county_percentage = county_percentage

    # 7: Print the county with the largest turnout to the terminal.
    winning_county_results = (
        f"\n-------------------------\n"
        f"\nLargest County Turnout: {winning_county} with {winning_county_percentage:.1f}% ({winning_county_votes:,})\n\n"
        f"-------------------------\n"
        f"\nCandidates' votes:\n\n")
